...
HD_PWD='C:/Users/033-16-0017/lab_04/lab_04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Time_multiplexing.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Time_multiplexing.tcl
