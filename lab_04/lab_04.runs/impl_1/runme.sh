...
HD_PWD='C:/Users/033-16-0017/lab_04/lab_04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Time_multiplexing.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Time_multiplexing.tcl -notrace
